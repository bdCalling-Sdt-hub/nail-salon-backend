...
router.post("/login", auth(USER_ROLE.SUPER_ADMIN, USER_ROLE.ADMIN), configureFileUpload(), AdminController.adminLogin);
router.post("/forgot-password", auth(USER_ROLE.SUPER_ADMIN, USER_ROLE.ADMIN), configureFileUpload(), AdminController.forgotPassword);
router.post("/verify-opt", auth(USER_ROLE.SUPER_ADMIN, USER_ROLE.ADMIN), configureFileUpload(), AdminController.verifyEmail);
router.post("/reset-password", auth(USER_ROLE.SUPER_ADMIN, USER_ROLE.ADMIN), configureFileUpload(), AdminController.resetPassword);
